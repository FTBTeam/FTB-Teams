...
public class TeamImpl implements Team
{
	...
	public boolean delete()
	{
		...
		File directory = manager.getServer().getWorldPath(LevelResourceHooks.create("data/ftbteams")).toFile();
	...
	public boolean addMember(ServerPlayer player)
	{
		...
		save();
		PlayerJoinedTeamEvent.EVENT.invoker().accept(new PlayerJoinedTeamEvent(this, oldTeam, player));
	...
	public void deserializeNBT(CompoundTag nbt)
	{
		...
		members.clear();
		ListTag membersNBT = nbt.getList("members", NbtType.STRING);
		...
		invited.clear();
		ListTag invitedNBT = nbt.getList("invited", NbtType.STRING);
		...
		allies.clear();
		ListTag alliesNBT = nbt.getList("allies", NbtType.STRING);
		...
		TeamLoadedEvent.EVENT.invoker().accept(new TeamLoadedEvent(this, nbt.getCompound("extra")));
	}
	...
	int msg(CommandSourceStack source, String message) throws CommandSyntaxException
	{
		...
		component.append("> ");
		component.append(newChatWithLinks(message));
	...
	{
		if (Platform.isModLoaded("ftbguilibrary"))
		{
