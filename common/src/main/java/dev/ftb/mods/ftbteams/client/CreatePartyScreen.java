...
public class CreatePartyScreen extends BaseScreen implements NordColors, InvitationSetup {
	...
	public void addWidgets() {
		...
		add(createTeamButton = new NordButton(this, new TranslatableComponent("ftbteams.create_party").withStyle(Style.EMPTY.withColor(TextColor.fromRgb(NordColors.GREEN.rgb()))), Icons.ACCEPT) {
			@Override
	...
	public void drawForeground(PoseStack matrixStack, Theme theme, int x, int y, int w, int h) {
		...
		theme.drawString(matrixStack, new TranslatableComponent("ftbteams.create_party"), x + w / 2F, y + 7, SNOW_STORM_1, Theme.CENTERED);
	}
	...
	private class InvitePanel extends Panel {
		...
		@Override
		public void addWidgets() {
			add(new TextField(this).addFlags(Theme.CENTERED).setText(new TranslatableComponent("ftbteams.gui.add_members")));
	...
	private class SettingsPanel extends Panel {
		...
		@Override
		public void addWidgets() {
			add(new TextField(this).setMaxWidth(width - 6).setText(new TranslatableComponent("ftbteams.gui.party_name")));
			...
			add(new TextField(this).setMaxWidth(width - 6).setText(new TranslatableComponent("ftbteams.gui.party_description")));
