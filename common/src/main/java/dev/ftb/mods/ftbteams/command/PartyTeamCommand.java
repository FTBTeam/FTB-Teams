        ...
        return Commands.literal("party")
                ...
                .then(Commands.literal("settings")
                        ...
                        .then(Commands.argument("key", TeamPropertyArgument.create())
                                ...
                                .executes(ctx -> getPartyTeam(ctx, TeamRank.OWNER).settings(ctx.getSource(), TeamPropertyArgument.get(ctx, "key"), null))
                        )
                )
                .then(Commands.literal("settings_for")
                        ...
                        .then(createTeamArg(TeamType.PARTY)
                                .then(Commands.argument("key", TeamPropertyArgument.create())
                                        ...
                                        .executes(ctx -> partyTeamArg(ctx, TeamRank.NONE).settings(ctx.getSource(), TeamPropertyArgument.get(ctx, "key"), null))
                                )
                        )
                )
