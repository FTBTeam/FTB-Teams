...
public class TeamArgument implements ArgumentType<TeamArgumentProvider> {
	...
	public static final DynamicCommandExceptionType API_OVERRIDE = new DynamicCommandExceptionType(object -> Component.translatable("ftbteams.party_api_only", object));
	...
	public static final DynamicCommandExceptionType PARTY_FULL = new DynamicCommandExceptionType(object -> Component.translatable("ftbteams.party_full", object));
